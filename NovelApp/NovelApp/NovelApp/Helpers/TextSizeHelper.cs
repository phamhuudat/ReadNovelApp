    ...
    public class TextSizeHelper
    {
        ...
        new Dictionary<TextFont, Dictionary<string, double>>()
        {
            {  TextFont.Arial, new Dictionary<string, double>()
               {
                //UpChar
                {CharUpWidthLargest, .94 },
                {CharUpWidthLarger, .88 },
                {CharUpWidthLarge1, .82 },
                {CharUpWidthLarge, .79 },
                {CharUpWidthNormal, .76 },
                {CharUpWidthSmall, .73},
                {CharUpWidthSmaller, .7 },
                {CharUpWidthSmallest, .67 },
                {CharUpWidthTiny, .64 },
                {CharUpWidthTinier, .62 },
                //DownChar
                {CharDownWidthLargest, .56 },
                {CharDownWidthLarger, .53 },
                {CharDownWidthLarge, .5 },
                {CharDownWidthNormal, .35 },
                {CharDownWidthSmall, .32},
                {CharDownWidthSmaller, .26 },
                {CharDownWidthSmallest, .23 },
                {CharDownWidthTiny, .21 },
               } },
